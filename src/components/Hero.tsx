...
export const Hero = () => {
  return (
    <section className="flex min-h-screen">
      ...
      <div className="container flex justify-start items-center px-5 mx-auto md:px-10">
        <div className="flex flex-col gap-5 tracking-wide ">
          <h1 className="max-w-[22ch] text-5xl text-[#F8F6F1] shadow-red-500 drop-shadow-md">
            LA MEJOR CALIDAD ESTA A SU DISPOSICIÓN
          </h1>
